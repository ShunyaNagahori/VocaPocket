...
export default function AddForm() {
  ...
  const [examples, setExamples] = useState([{ id: uuidv4(), text: "", translation: "" }]);
  ...
  return (
    <div className="p-4 sm:py-8 max-w-7xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold tracking-tight mb-6">新しいボキャブラリーを追加</h1>
        <Form {...form}>
            ...
            <Card className="mb-6 border-t-4 border-t-primary">
              ...
              <FormField
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {tags.map((tag) => (
                      <Badge key={tag} className="flex items-center gap-1 px-3 py-1 bg-yellow-500 text-white dark:bg-yellow-600 dark:text-white">
                        {tag}
                        <button
                          type="button"
              ...
              <CardFooter className="p-6 bg-muted/50">
                <Button type="submit" variant="gradient" className="w-full" disabled={isSubmitting}>
                  {isSubmitting ? "登録中..." : `${currentGenre === "word" ? "単語" : currentGenre === "phrase" ? "フレーズ" : "文法"}を追加`}
                </Button>
              </CardFooter>
            </Card>
          </form>
